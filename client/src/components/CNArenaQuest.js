...
const CNArenaQuest = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#020617', color: '#f8fafc', padding: '40px' }}>
      ...
      <button onClick={() => navigate('/world/cn')} style={{ background: 'none', border: 'none', color: '#818cf8', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '30px' }}>
        ...
        <AnimatePresence mode="wait">
          ...
          {phase === 'result' && (
            <motion.div key="result" initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} style={{ textAlign: 'center', padding: '80px 40px', background: '#1e1b4b', borderRadius: '30px', border: '2px solid #6366f1' }}>
              ...
              <button onClick={() => navigate('/world/cn')} style={{ width: '100%', padding: '18px', background: '#334155', color: 'white', border: 'none', borderRadius: '12px', fontWeight: 'bold', cursor: 'pointer' }}>
